...
class View_TournamentList(discord.ui.View):
    def __init__(self, tournament_list: dict, timeout=180) -> None:
        ...
        self.add_item(Select_TournamentList(tournament_list)) #2. ->
        return
...
class View_ManageTournament(discord.ui.View):
    def __init__(self, tournament_data: dict) -> None:
        ...
        self.add_item(Button_TournamentStart(tournament_data))
        self.add_item(Button_TournamentUpdate(tournament_data))
        self.add_item(Button_TournamentCancel(tournament_data))
        return
...
class Button_TournamentUpdate(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction) -> None:
        await interaction.response.send_modal(Modal_TournamentUpdate(self.tournament_data))
        return
